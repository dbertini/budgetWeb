package it.db.budget.client.place;
...
public class NameTokens {
    ...
    public static String getAnagSupermercati() {
        return ANAG_SUPERMERCATI;
    }

    public static String getAnagProdotti() {
        return ANAG_PRODOTTI;
    }
