...
public class AnagProdottiPresenter extends Presenter<AnagProdottiPresenter.MyView, AnagProdottiPresenter.MyProxy> implements AnagProdottiUiHandlers {

	PlaceManager placeManager;
	
	interface MyView extends View, HasUiHandlers<AnagProdottiPresenter> {
		//void setDataSourceName(String aReportName);
	}
	
	@ProxyStandard
	@NameToken(NameTokens.ANAG_PRODOTTI)
	interface MyProxy extends ProxyPlace<AnagProdottiPresenter> {
	}
	
	@Inject
	AnagProdottiPresenter(EventBus eventBus, MyView view, MyProxy proxy, PlaceManager aPlaceManager) {
